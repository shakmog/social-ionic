class AssociatesController < ApplicationController
  ...
  private
    ...
    def associate_params
      params.require(:associate).permit(:surname, :other_names, :dob, :contact_add, :sec_institution, :sec_certificate, :sec_date, :uni_institution, :uni_certificate, :uni_date, :other_institution, :other_certificate, :other_date, :personal_statement, :hobbies, :telephone, :email)
    end
end
